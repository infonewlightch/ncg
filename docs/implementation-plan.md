...
- [x] UI 문구 732개 카탈로그·빌드 누락 검사·스페인어 팩과 QT 안내 초안.
...
- [ ] 퀴즈 기록·영상 책갈피 추가 클라우드 동기화. 현재 기기 저장.
...
- [x] NCG 전용 Supabase 연결 및 승인된 001–007 및 비공개 책갈피 008 적용. 신규 테이블까지 RLS, 공개/비공개 익명 접근 검사 통과.
...
- [x] GitHub infonewlightch/ncg 백업. 기능 변경을 main에 백업하고 연속 배포. 164 tests/28 files 및 build 통과(인증 보완 단계).
