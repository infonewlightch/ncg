...
## 2026-09-25 라오어 — 외부 열람 연결

라오어 선택 시 **Biblica Lao Contemporary Version (LCV, 2023/2025)**의 [정식 YouVersion 열람 페이지](https://www.bible.com/versions/3755)를 안내합니다. Biblica의 66권 신앙고백과 해당 판본의 출판사/번역 계보를 확인했습니다. 공급 페이지 목차는 구약39+신약27, 총1189장의 링크가 NCG 장 수 기준과 일치합니다. 상세 기록: [PDF·LCV 조사](verification/lao-bible-2026-09-25.json).

- 성경 읽기 및 QT는 해당 장의 YouVersion 링크를 제공합니다. 나훔은 NAH→NAM으로 변환합니다.
- `3755`는 외부 열람 전용입니다. YouVersion 본문 API 허용 목록은 비어 있으며 앱 내 전문·오프라인 저장·번역 권한을 얻었다고 표시하지 않습니다. 사이트 제공 본문을 복제하지 않습니다.
- 사용자 제공 `Lao-The_New_Testament_2015.pdf`는 **492쪽 신약27권**이며 구약은 없습니다. 1991 Thailand Bible Society 자료를 개정했다는 설명이 있지만 2015 개정 주체와 공개 재배포 조건은 확인되지 않았습니다. LCV 또는 RLV15와 같은 판본으로 간주하지 않습니다.
- 제공 PDF는 글자 모양은 정상이나 Unicode 추출 시 모음·성조 손상 위험이 있습니다. 원본은 사용자 파일로 유지하고, 손상된 추출문이나 AI 교정문을 성경 본문으로 등록하지 않았습니다. 정확한 공급 원문/이용 조건 확인이 남아 있습니다.
- 목차·출판사 확인은 교회의 전 장절 신학 감수 완료를 뜻하지 않습니다.
