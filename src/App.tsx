...
export default function App(){
 ...
 const {state,t,update,storageError,notice,notify,interfaceStatus,retryInterface}=useApp();const [path,setPath]=useState(location.hash.slice(1)||'/');const [language,setLanguage]=useState(false);const [video,setVideo]=useState<Video|null>(null);const [add,setAdd]=useState(false);
 ...
 else if(root==='sermons')content=<Sermons key={root} onVideo={setVideo} onAdd={()=>setAdd(true)} onLanguage={openLanguage}/>;
