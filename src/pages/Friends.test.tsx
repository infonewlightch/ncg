...
it('requests translation by message ID without resending private text',async()=>{const fetcher=vi.fn().mockResolvedValue({ok:true,json:async()=>({text:'Translated message'})});vi.stubGlobal('fetch',fetcher);mocks.language='es';mocks.read.mockResolvedValue({data:[message('Private original','33333333-3333-4333-8333-333333333333')],error:null});await openChat();expect(JSON.parse(fetcher.mock.calls[0][1].body)).toEqual({messageId:'33333333-3333-4333-8333-333333333333',target:'es'});});
